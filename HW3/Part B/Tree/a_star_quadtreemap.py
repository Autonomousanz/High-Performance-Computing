# -*- coding: utf-8 -*-
"""
Created on Mon Oct 11 21:13:03 2021
    ...
    while candidates:
        ...
        for til, deltacost in movements:
            ...
            if til not in path_record:
                ...
                total_new_cost_to_goal =  quadtreemap.Point.disOf2Points(til.getCenter(),goal.getCenter())
                candidates.put((dis +deltacost + total_new_cost_to_goal, curr_node, til))
